...
class _ProfilepageState extends State<Profilepage> {
  ...
  void initState() {
    super.initState();
    email =  _prefs.then((SharedPreferences prefs) => prefs.getString("email") ?? "");
  }
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  currentAccountPicture: CircleAvatar(
                    child: ClipOval(
                      child: Image.network(
                        profile?.image ?? 'https://www.ncbp.co.uk/wp-content/uploads/2016/11/no_image.jpg',
                        fit: BoxFit.cover,
                        width: 90,
                        height: 90,
                      ),
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => new UpdateProfile(profile!.email!,profile!.fullName!,profile!.phone!,profile!.address!, profile.image ?? "")));
                  },
                ),
                ListTile(
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ChangePassword(profile!.email!
                            )));
                  },
                ),
                Divider(),
